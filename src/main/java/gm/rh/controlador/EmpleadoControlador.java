...
public class EmpleadoControlador {
    private static final Logger logeer = LoggerFactory.getLogger(EmpleadoControlador.class);
    ...
    public List<Empleado> obtenerEmpleados() {
        ...
        empleados.forEach(empleado -> logeer.info(empleado.toString()));
        return empleados;
    ...
    public Empleado agregarEmpleado(@RequestBody Empleado empleado) {
        logeer.info("El empleado a agregar" + empleado);
    ...
    public ResponseEntity<Empleado> obtenerEmpleadoPorId(@PathVariable Integer id) {
        ...
        if (empleado == null) {
            throw new RecursoNoEncontradoException("No se encontro el empleado id" + id);
        }
